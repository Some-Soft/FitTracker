    ...
    class Register {
        ...
        private static Stream<Arguments> incorrectLengthTestDataProvider() {
            return Stream.of(
                    ...
                    of(new RegisterRequest("a".repeat(65), "user@example.com", "password"), "username", "Username must be between 3 and 64 characters"),
                    of(new RegisterRequest("user", "a", "password"), "email", "Email must be between 3 and 254 characters"),
                    of(new RegisterRequest("user", "a".repeat(255), "password"), "email", "Email must be between 3 and 254 characters"),
                    of(new RegisterRequest("user", "user@example.com", "a"), "password", "Password must be between 3 and 30 characters"),
                    of(new RegisterRequest("user", "user@example.com", "a".repeat(31)), "password", "Password must be between 3 and 30 characters")
            );
        }
