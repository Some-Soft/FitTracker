...
import static com.fittracker.fittracker.exception.ErrorResponse.withMessage;
...
public class ProductControllerIntegrationTest extends BaseIntegrationTest {
    ...
    class Post {
        ...
        void givenValidPostRequest_shouldSaveAndReturnProduct() throws Exception {
            ...
            compareUpTo(allProducts.iterator().next(), expectedProduct, "id", "updatedAt");
        }
    ...
    class Get {
        ...
        void givenGetRequestWithNonexistentId_shouldReturnError() throws Exception {
            var expectedResponse = withMessage(
        ...
        void givenGetRequestWithExistingIdAndActiveFalse_shouldReturnError() throws Exception {
            deactivateExisting();
            var expectedResponse = withMessage("Product not found for id: " + id);
        ...
        private void deactivateExisting() {
            Product deactivated = productRepository.findAll().iterator().next();
            deactivated.setActive(false);
            productRepository.save(deactivated);
        }

        private void addNewVersion() {
            Product active = productRequestWithKcal(300).toProduct();
            active.setId(id);
            active.setUserId(UUID.fromString("948cc727-68e5-455c-ab6d-942e585bde0d"));
            active.setVersion(1);
            productRepository.saveNew(active);
        }
    ...
    class Put {
        ...
        void givenValidPutRequestWithNoChanges_shouldReturnError() throws Exception {
            ...
            var expectedResponse = withMessage("Updated product must differ");
    ...
    class Delete {
        ...
        @Test
        void givenValidDeleteRequest_shouldSetActiveToFalseAnReturnNoContent() throws Exception {
            ...
            compareUpTo(dbProducts.iterator().next(), expectedProduct, "id", "updatedAt");
        }
        ...
        void givenDeleteRequestWithNonexistentId_shouldReturnError() throws Exception {
            var response = makeRequest(ENDPOINT + "/fed4b756-cfc3-4d99-910f-5f27faad59fe", DELETE, NOT_FOUND,
                ErrorResponse.class);
            var expectedResponse = withMessage("Product not found for id: fed4b756-cfc3-4d99-910f-5f27faad59fe");
