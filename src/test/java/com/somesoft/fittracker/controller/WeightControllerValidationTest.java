    ...
    class Get {
        ...
        class Weights {
            ...
            private static Stream<Arguments> getWeightsRequestTestDataProvider() {
                return Stream.of(
                    of("", BAD_REQUEST, "{\"field\":\"startDate\",\"message\":\"Parameter must not be null\"}",
                        never()),
                    of("?startDate=123&endDate=2020-01-01", BAD_REQUEST,
                        "{\"field\":\"startDate\",\"message\":\"Invalid data type\"}", never()),
                    of("?startDate=2020-01-01&endDate=123", BAD_REQUEST,
                        "{\"field\":\"endDate\",\"message\":\"Invalid data type\"}", never()),
